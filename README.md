...
<img src="https://raw.githubusercontent.com/statzhero/data-projects/master/assets/showmethemoney.png" alt="" width="529" height="295"></a>
...
A joint project between  Deloitte and the Open Data Institute on how election data can help give insights into voting behaviour. I enjoyed this project a lot, as it was interesting, a fast turn-around and I got to apply various models among them <a href="https://www.quora.com/How-does-randomization-in-a-random-forest-work" target="_blank">random forests</a>.
...
<img src="https://raw.githubusercontent.com/statzhero/data-projects/master/assets/democratic-engagement.png" alt="" width="529" height="295"></a>
...
The [presentation slides](https://github.com/londonqs/qs/blob/master/meetup-content/2014-02/Survey%20overview.pdf) give a brief overview about the findings. For me it was interesting to [play around with SPSS and R integration](https://github.com/statzhero/qs-survey/), that is variable labels. There's also a nice integration with Google documents and R. I was particularly pleased when I reused code that was years old – and it worked.

<a href="https://github.com/londonqs/qs/blob/master/meetup-content/2014-02/Survey%20overview.pdf"  target="_blank">
<img src="https://raw.githubusercontent.com/statzhero/data-projects/master/assets/qs-survey.png" alt="" width="529" height="295"></a>
...
<img src="https://raw.githubusercontent.com/statzhero/data-projects/master/assets/prioritise-opendata.png" alt="" width="529" height="295"></a>
...
* Making [fast consensus clustering in R](https://github.com/statzhero/consensusclustering
...
* Enjoy the rabbit hole of econometrics in my Master's thesis: [Empirics in Biotechnology: How does public R&D support affect private R&D investments?](https://github.com/statzhero/netzseite/raw/gh-pages/docs/diplomarbeit_biotech_ATZ.pdf)
* A tiny collection of [R scripts](https://gist.github.com/statzhero), but I am really proud of `row-sample`, a function to make analysing a random subset easier.
...
* A vain, self-referential [visualisation of temperature levels of 10 000 days](https://github.com/statzhero/Weather_timeseries_BZ/blob/master/cal%2010000%20days.pdf) for my 10 000th day alive.
* [SCHEME_TUFTE](https://ideas.repec.org/c/boc/bocode/s457285.html): **Stata module** to provide a Tufte-inspired graphics scheme
* Some [templates](https://github.com/statzhero/SPSS-tools) to make **SPSS charts** look more appealing
...
* [Cleaning up](https://github.com/statzhero/wine-cellar) the dataset from the [annual statement on the Government Wine Cellar](https://www.gov.uk/government/publications/annual-statement-on-the-government-wine-cellar-for-the-financial-year-2013-to-14). Not a glamorous job but someone has to do it.
...
* And to conclude on a philosophical note: [What Is Data? Exploring The Question That No One Asks](https://demotrends.org/2013/11/12/what-is-data-exploring-the-question-that-no-one-asks/)
